...
class Player extends StatefulWidget {
  ...
  Player({Key key, @required this.appbarTitle}) : super(key: key);
...
class PlayerState extends State<Player> {
  ...
  _color() {
    if (widget.appbarTitle == "Player 1") {
      return Colors.red;
    } else if (widget.appbarTitle == "Player 2") {
        return Colors.yellow;
      } else if (widget.appbarTitle == "Player 3") {
        return Colors.green;
      }
  }
